...
| [`diagnostico-viewport.md`](diagnostico-viewport.md) | **Sólo en la rama `diagnostico-viewport`.** Cómo prender el panel de diagnóstico del viewport en el iPhone y qué mirar para separar las dos hipótesis de la barra elevada. |
